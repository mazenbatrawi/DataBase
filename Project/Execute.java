...
public class Execute implements Initializable {
    ...
    private void readData() throws SQLException, ClassNotFoundException {
        ...
        while(resultSet.next()){
            ...
            int day = (expire.charAt(0) - '0') * 10 + expire.charAt(1) - '0';
            int month = (expire.charAt(3) - '0') * 10 + expire.charAt(4) - '0';
            int year = (expire.charAt(6) - '0') * 1000 + (expire.charAt(7) - '0') * 100 + (expire.charAt(8) - '0') * 10 +
                    (expire.charAt(9) - '0');
