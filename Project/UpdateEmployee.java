    ...
    void update(MouseEvent event) throws SQLException, ClassNotFoundException {
        ...
        if(sid.getText().isEmpty() && snational_id.getText().isEmpty() && sname.getText().isEmpty() && sphone.getText().isEmpty() &&
            sshift.getText().isEmpty() && ssalary.getText().isEmpty() && ssection.getText().isEmpty() &&
                shire_date.getText().isEmpty() && spassword.getText().isEmpty()){
            ...
            alert.showAndWait();
                ...
                hire_date.getText().isEmpty() && password.getText().isEmpty()){
        ...
        else if(!shire_date.getText().isEmpty() && (shire_date.getText().length() != 10 ||
                (shire_date.getText().length() == 10 &&
                        (shire_date.getText().charAt(2) != '-' || shire_date.getText().charAt(5) != '-')))){
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setHeaderText(null);
            alert.setContentText("Please Check The Search Hire Date Format (dd-mm-yyyy)");
            alert.showAndWait();
        }
        else if(!hire_date.getText().isEmpty() && (hire_date.getText().length() != 10 ||
                (hire_date.getText().length() == 10 &&
                        (hire_date.getText().charAt(2) != '-' || hire_date.getText().charAt(5) != '-')))){
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setHeaderText(null);
            alert.setContentText("Please Check The New Hire Date Format (dd-mm-yyyy)");
            alert.showAndWait();
        }
        else {
            ...
            if (!hire_date.getText().isEmpty()) query += "hire_date = \"" + hire_date.getText() + "\", ";
            ...
            if (!shire_date.getText().isEmpty()) query += "hire_date = \"" + shire_date.getText() + "\" and ";
