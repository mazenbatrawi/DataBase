...
public class InsertProduct implements Initializable {
    ...
    void insert(ActionEvent event) throws SQLException, ClassNotFoundException {
        if(barcode.getText().isEmpty() || company_id.getText().isEmpty() || expire_date.getText().isEmpty() ||
            name.getText().isEmpty() || price.getText().isEmpty() || production_date.getText().isEmpty() ||
